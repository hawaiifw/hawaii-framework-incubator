...
import org.hawaiiframework.validation.constraints.validation.IbanOfCountryValidator;
...
@Retention(RUNTIME)
@Documented
@Constraint(validatedBy = IbanOfCountryValidator.class)
@SuppressWarnings("checkstyle:typename")
public @interface IbanOfCountry {
