...
import org.hawaiiframework.validation.constraints.validation.Iso8601_DateTimeValidator;
...
@Retention(RUNTIME)
@Documented
@Constraint(validatedBy = Iso8601_DateTimeValidator.class)
@SuppressWarnings("checkstyle:typename")
public @interface Iso8601_DateTime {
